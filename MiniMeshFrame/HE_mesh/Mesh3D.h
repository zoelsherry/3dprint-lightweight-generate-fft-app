...
////////////////////////////////////////////////////////////////
// this halfedge structure only appropriate for .obj format,
// TODO: cann't use the .stl format!
////////////////////////////////////////////////////////////////
...
public:
	...
	*/
	...
	// FILE IO
	void LoadMeshFile(const char* fins);
	bool FileExtension(std::string filename, std::string extension);
	...
	void LoadFromSTLFile(const char* fins);  // TODO: file the function
	bool LoadASCIISTL(const char* fins);
	bool LoadBinarySTL(const char* fins);
	...
	int rcol_find(float a[][COR3_MAX], int m, int n, Vec3f r);
