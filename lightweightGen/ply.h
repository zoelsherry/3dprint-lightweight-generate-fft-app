...
int PlyReadOrientedPoints(char* fileName,std::vector<OrientedVertex>& points,int& file_type);
int PlyWriteTriangles(char* fileName,std::vector<TriangleIndex>& triangles,std::vector<Vertex>& vertices,int file_type);
